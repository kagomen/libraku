  ...
  return (
    <div className="absolute">
      <span className="fixed -left-8 top-16  transform opacity-70">
        ...
        >
          <img
            ...
            width="240px"
            height="240px"
            className="lg:h-[360px] lg:w-[360px] lg:-translate-y-12"
            alt=""
          />
        </motion.div>
      </span>
      <span className="fixed right-0 top-[380px] opacity-50">
        ...
        >
          <img src={miniBook} width="100px" height="100px" className="lg:h-[200px] lg:w-[200px]" alt="" />
        </motion.div>
      </span>
      <span className="fixed -left-6 top-[560px] opacity-60">
        ...
        >
          <img src={normalBook} width="180px" height="180px" className="lg:translate-y-12 lg:scale-90" alt="" />
        </motion.div>
      </span>
    </div>
  )
