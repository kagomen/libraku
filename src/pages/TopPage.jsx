...
export default function TopPage() {
  ...
  return (
    <div className="mx-auto sm:mb-[120px] px-3 w-full sm:px-[24px] md:px-0 md:max-w-[80%] relative">
      <img src={src} className="absolute sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[65%] -top-[8px] md:top-0 xl:-top-[40px] -right-[32px] opacity-40 z-0" />
