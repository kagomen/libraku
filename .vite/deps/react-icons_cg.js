import { GenIcon } from './chunk-MLQSBXZT.js'
...
function CgAbstract(props) {
  return GenIcon({
    ...
    child: [
      { tag: 'path', attr: { d: 'M5 5H19V19H16L16 8H5V5Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgAdidas(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M1.3294 19L0.731323 17.9641L5.06145 15.4641L7.1029 19H1.3294Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M15.1858 19H9.4123L5.7935 12.7321L10.1236 10.2321L15.1858 19Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M23.2687 19H17.4952L10.8557 7.5L15.1858 5L23.2687 19Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgAlarm(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M5.45887 2L1 6.01478L2.33826 7.50107L6.79713 3.48629L5.45887 2Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M11 8H13V12H16V14H11V8Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
      ...
      {
        tag: 'path',
        attr: { d: 'M18.5411 2L23 6.01478L21.6617 7.50107L17.2029 3.48629L18.5411 2Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgAlignBottom(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 10H17V16H13V10Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      { tag: 'path', attr: { d: 'M11 4H7V16H11V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M18 18H6V20H18V18Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgAlignCenter(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 13H15V17H9V13Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      { tag: 'path', attr: { d: 'M6 7H18V11H6V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgAlignLeft(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M8 13H14V17H8V13Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      { tag: 'path', attr: { d: 'M6 6H4V18H6V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 7H8V11H20V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgAlignMiddle(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 9H17V15H13V9Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      { tag: 'path', attr: { d: 'M7 6H11V18H7V6Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgArrowAlignH(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 7H11V17H13V7Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgArrowAlignV(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M7 11L7 13H17V11H7Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgArrowsShrinkH(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M1 7H3V17H1V7Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
      ...
      { tag: 'path', attr: { d: 'M23 7H21V17H23V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgArrowsShrinkV(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M17 1V3L7 3V1L17 1Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
      ...
      { tag: 'path', attr: { d: 'M17 23V21H7V23H17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgAssign(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M6 6H10V4H4V10H6V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 18H6V14H4V20H10V18Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M14 6H18V10H20V4H14V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M14 18H18V14H20V20H14V18Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgBattery(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M6 15C5.44772 15 5 14.5523 5 14V10C5 9.44772 5.44772 9 6 9H12V15H6Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgBolt(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M9 21.5L17.5 13L13 10L15 2.5L6.5 11L11 14L9 21.5Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgBorderAll(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M6.5 6.5H17.5V17.5H6.5V6.5Z', stroke: 'currentColor', strokeWidth: '3' }, child: [] },
    ],
  })(props)
}
function CgBorderBottom(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M8 8H16V15H19V5H5V15H8V8Z', fill: 'currentColor', fillOpacity: '0.3' }, child: [] },
      { tag: 'path', attr: { d: 'M5 17H19V20H5V17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgBorderLeft(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M16 8V16H9L9 19H19L19 5L9 5V8H16Z', fill: 'currentColor', fillOpacity: '0.3' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M7 5L7 19H4L4 5L7 5Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgBorderRight(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M8 16V8H15V5L5 5L5 19H15L15 16H8Z', fill: 'currentColor', fillOpacity: '0.3' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M17 19L17 5L20 5L20 19H17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgBorderStyleDashed(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M4 11H8V13H4V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 11H14V13H10V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 11H16V13H20V11Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgBorderStyleDotted(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M3 11H1V13H3V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 11H5V13H7V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 11H11V13H9V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 11H13V13H15V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 11H19V13H17V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M23 11H21V13H23V11Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgBorderStyleSolid(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [{ tag: 'path', attr: { d: 'M2 11H22V13H2V11Z', fill: 'currentColor' }, child: [] }],
  })(props)
}
function CgBorderTop(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M8 16H16V9L19 9L19 19L5 19L5 9L8 9V16Z', fill: 'currentColor', fillOpacity: '0.3' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M5 7L19 7V4L5 4L5 7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgBot(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M14.1254 13H10.1254V15H14.1254V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgBrackets(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 7V9H9V15H11V17H7V7H11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 15H13V17H17V7H13V9H15V15Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgBriefcase(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M14 11H10V13H14V11Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgBrowse(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M8 5H16V7H8V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 9H8V11H16V9Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgCPlusPlus(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M15 9H13V11H11V13H13V15H15V13H17V11H15V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 9H22V11H24V13H22V15H20V13H18V11H20V9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgCalculator(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M17 5H7V7H17V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 9H9V11H7V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 13H7V15H9V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 17H9V19H7V17Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 9H11V11H13V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 13H13V15H11V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 17H11V19H13V17Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 9H17V11H15V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 13H15V19H17V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgCap(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M8 18V20H16V18H8Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgCaptions(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 8V10H8V14H11V16H6V8H11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M18 8V10H15V14H18V16H13V8H18Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgCardDiamonds(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 7.75736L7.75736 12L12 16.2426L16.2426 12L12 7.75736Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgCast(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M2 13C5.86599 13 9 16.134 9 20H7C7 17.2386 4.76142 15 2 15V13Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M2 17C3.65685 17 5 18.3431 5 20H2V17Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { d: 'M2 9C8.07513 9 13 13.9249 13 20H11C11 15.0294 6.97056 11 2 11V9Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgComment(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M17 9H7V7H17V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 13H17V11H7V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgCopy(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 7H7V5H13V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 11H7V9H13V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 15H13V13H7V15Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgDarkMode(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8V16Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgDatabase(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 9V7H7V9H5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 9H19V7H9V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 15V17H7V15H5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19 17H9V15H19V17Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgDesignmodo(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M22 10.5544H17V7.55444H22V10.5544Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgDialpad(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5.5 3H8.5V6H5.5V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5.5 8H8.5V11H5.5V8Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5.5 13V16H8.5V13H5.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10.5 3H13.5V6H10.5V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10.5 8V11H13.5V8H10.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10.5 13H13.5V16H10.5V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10.5 18V21H13.5V18H10.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15.5 3H18.5V6H15.5V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15.5 8V11H18.5V8H15.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15.5 13H18.5V16H15.5V13Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgDigitalocean(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M7 18V13H12V18H7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 18V22H7V18H3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 18H1V16H3V18Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgDisc(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M5 12C5 8.13401 8.13401 5 12 5V7C9.23858 7 7 9.23858 7 12H5Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M12 17C14.7614 17 17 14.7614 17 12H19C19 15.866 15.866 19 12 19V17Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgDisplayFlex(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M6 17V7H8V17H6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 7V17H18V7H16Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M2 3H22V21H2V3ZM4 5V19H20V5H4Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgDisplayFullwidth(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M2 5H22V3H2V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M2 21H22V19H2V21Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M2 7V17H22V7H2ZM4 9H20V15H4V9Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgDisplayGrid(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M7 7V11H11V7H7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 7H17V11H13V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 13V17H17V13H13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 13H11V17H7V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M3 3H21V21H3V3ZM5 5V19H19V5H5Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgDisplaySpacing(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M3 21V3H5V21H3Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M7 3H17V21H7V3ZM9 5V19H15V5H9Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M19 3V21H21V3H19Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgDistributeHorizontal(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M11 9H13V15H11V9Z', stroke: 'currentColor', strokeOpacity: '0.5', strokeWidth: '2' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M5 5V19H7V5H5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 5V19H19V5H17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgDistributeVertical(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M9 11H15V13H9V11Z', stroke: 'currentColor', strokeOpacity: '0.5', strokeWidth: '2' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M19 7H5V5H19V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19 19H5V17H19V19Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgDockBottom(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M2 20V4H22V20H2ZM4 6H20V14H4V6Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgDockLeft(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M2 4H22V20H2V4ZM8 6H20V18H8V6Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgDockRight(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M2 4H22V20H2V4ZM16 18V6H4V18H16Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgDuplicate(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M19 5H7V3H21V17H19V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 13V11H11V13H13V15H11V17H9V15H7V13H9Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M3 7H17V21H3V7ZM5 9H15V19H5V9Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgEditFlipH(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M13 3H11V21H13V3Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgEditFlipV(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M21 13V11L3 11V13H21Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgEditStraight(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 4C15.866 4 19 7.13401 19 11H5C5 7.13401 8.13401 4 12 4Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M5 13H1V11H5V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { d: 'M19 13C19 16.866 15.866 20 12 20C8.13401 20 5 16.866 5 13H19Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M19 13V11H23V13H19Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgEject(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M6.00014 17.3835H18.0001V15.3835H6.00014V17.3835Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgEnter(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M20 5H8V9H6V3H22V21H6V15H8V19H20V5Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgExport(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M5 20.9819V10.9819H9V8.98193H3V22.9819H21V8.98193H15V10.9819H19V20.9819H5Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgExtensionAdd(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M16 4H18V6H20V8H18V10H16V8H14V6H16V4Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgExtensionRemove(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M20 7H14V9H20V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgFileAdd(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M10 18V16H8V14H10V12H12V14H14V16H12V18H10Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgFileDocument(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M7 18H17V16H7V18Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 14H7V12H17V14Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 10H11V8H7V10Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgFileRemove(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 15H15V13H9V15Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgFolderAdd(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M11 14.5V16.5H13V14.5H15V12.5H13V10.5H11V12.5H9V14.5H11Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgFolderRemove(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 14.5V12.5H15V14.5H9Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgFontHeight(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M21 5V3H3V5H21Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 19V21H3V19H21Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgFontSpacing(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M19 21H21V3H19L19 21Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 21H3V3H5L5 21Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgFormatHeading(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [{ tag: 'path', attr: { d: 'M6 19V5H8V11H16V5H18V19H16V13H8V19H6Z', fill: 'currentColor' }, child: [] }],
  })(props)
}
function CgFormatIndentDecrease(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M20 7H4V5H20V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 11H12V9H20V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M12 15H20V13H12V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 9L4 12L9 15V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M4 17V19H20V17H4Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgFormatIndentIncrease(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M20 11H12V9H20V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M12 15H20V13H12V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M4 15L9 12L4 9V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M4 17V19H20V17H4Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgFormatLineHeight(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M22.8412 7H8.84119V5H22.8412V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M22.8412 11H8.84119V9H22.8412V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8.84119 15H22.8412V13H8.84119V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M22.8412 19H8.84119V17H22.8412V19Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgFormatStrike(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 7H17V5H7V7H11V10H13V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 19V14H13V19H11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 13H19V11H5V13Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgFormatText(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M6.5 3H3V6.5H4V4H6.5V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8.5 4V3H11V4H8.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 4H15.5V3H13V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17.5 3V4H20V6.5H21V3H17.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 8.5H20V11H21V8.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 13H20V15.5H21V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 17.5H20V20H17.5V21H21V17.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15.5 21V20H13V21H15.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 21V20H8.5V21H11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M6.5 21V20H4V17.5H3V21H6.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 15.5H4V13H3V15.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 11H4V8.5H3V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 9.5H7V7.5H17V9.5H13V16.5H11V9.5Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgFramer(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M12 21L12 9L6 9L6 15L12 21Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      { tag: 'path', attr: { d: 'M18 9V3H6L12 9H6V15H18L12 9H18Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgGames(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M6 13H4V11H6V9H8V11H10V13H8V15H6V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgGhost(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M3 4H15V8H3V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 8H17V4H21V8Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 10H21V14H3V10Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 16H3V20H11V16Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 16V20H21V16H13Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgGitter(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 1.5H7V14.5H5V1.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 4.5H11V22.5H9V4.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 4.5H13V22.5H15V4.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 4.5H19V14.5H17V4.5Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgIfDesign(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M10 5H14V19H10V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 19V10H9V19H5Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
      ...
      { tag: 'path', attr: { d: 'M15 5H19V9H15V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19 10H15V14H19V10Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgImport(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M5 9.98193V19.9819H19V9.98193H15V7.98193H21V21.9819H3V7.98193H9V9.98193H5Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgIndieHackers(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M4 6H7V18H4V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 6H13V10.5H17V6H20V18H17V13.5H13V18H10V6Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgInpicture(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M20 12H14V17H20V12Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgInternal(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M11 4.70581V6.70581H5V18.7058H17V12.7058H19V20.7058H3V4.70581H11Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgLayoutGridSmall(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M7 7H9V9H7V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 7H13V9H11V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 7H15V9H17V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 11H9V13H7V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 11H11V13H13V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 11H17V13H15V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 15H7V17H9V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 15H13V17H11V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 15H15V17H17V15Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgLayoutGrid(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 7H7V11H11V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 13H7V17H11V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 13H17V17H13V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 7H13V11H17V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgLayoutList(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 7H7V9H9V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 13V11H9V13H7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 15V17H9V15H7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11 15V17H17V15H11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 13V11H11V13H17Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17 7V9H11V7H17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgLoadbarAlt(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'rect',
        attr: { opacity: '0.3', x: '3', y: '10', width: '18', height: '4', rx: '2', fill: 'currentColor' },
        child: [],
      },
      { tag: 'rect', attr: { x: '7', y: '10', width: '10', height: '4', rx: '2', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgLoadbarDoc(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M8 7H16V9H8V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8 11H16V13H8V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8 15H13V17H8V15Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgLoadbarSound(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 6H13V18H11V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 13H9V18H7V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 9H17V18H15V9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgLoadbar(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'rect', attr: { x: '3', y: '10', width: '18', height: '4', rx: '2', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgLoupe(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 11V8H13V11H16V13H13V16H11V13H8V11H11Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgMagnet(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M8 2.5H4V5.5H8V2.5Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      { tag: 'path', attr: { d: 'M20 2.5H16V5.5H20V2.5Z', fill: 'currentColor', fillOpacity: '0.5' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgMaximizeAlt(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M3 3H9V5H6.46173L11.3047 9.84298L9.8905 11.2572L5 6.3667V9H3V3Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M3 21H9V19H6.3764L11.3046 14.0718L9.89038 12.6576L5 17.548V15H3V21Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M15 21H21V15H19V17.5244L14.1332 12.6576L12.719 14.0718L17.6472 19H15V21Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M21 3H15V5H17.5619L12.7189 9.84301L14.1331 11.2572L19 6.39032V9H21V3Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgMaximize(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M3 3H9V5H5V9H3V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 21H9V19H5V15H3V21Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 21H21V15H19V19H15V21Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 3H15V5H19V9H21V3Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgMaze(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M11.3709 9.59273L8.77816 7L1 14.7782L3.59272 17.3709L11.3709 9.59273Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgMenuGridR(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M4 4H8V8H4V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M4 10H8V14H4V10Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8 16H4V20H8V16Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 4H14V8H10V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M14 10H10V14H14V10Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 16H14V20H10V16Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 4H16V8H20V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 10H20V14H16V10Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 16H16V20H20V16Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgMenuHotdog(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M7 6C5.34315 6 4 7.34315 4 9H20C20 7.34315 18.6569 6 17 6H7Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M7 18C5.34315 18 4 16.6569 4 15H20C20 16.6569 18.6569 18 17 18H7Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgMenuOreos(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M7 3C5.34315 3 4 4.34315 4 6H20C20 4.34315 18.6569 3 17 3H7Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M7 11C5.34315 11 4 9.65685 4 8H20C20 9.65685 18.6569 11 17 11H7Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M7 13C5.34315 13 4 14.3431 4 16H20C20 14.3431 18.6569 13 17 13H7Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M7 21C5.34315 21 4 19.6569 4 18H20C20 19.6569 18.6569 21 17 21H7Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgMicrosoft(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M3 3H11V11H3V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 13H11V21H3V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 3H21V11H13V3Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 13H21V21H13V13Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgMinimize(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 9H3V7H7V3H9V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 15H3V17H7V21H9V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 15H15V21H17V17H21V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 9.00012H21V7.00012H17V3.00012H15V9.00012Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgMoveDown(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M7 5H9V13H7V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 5H17V13H15V5Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgMoveLeft(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M19.071 17V15H11.071V17H19.071Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19.071 9V7H11.071V9H19.071Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgMoveRight(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 17V15H13V17H5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 9V7H13V9H5Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgMoveTask(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M18.9641 7H10.9641V9H18.9641V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M6 8.82864V15.1714L9.9642 12L6 8.82864Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M18.9641 11H10.9641V13H18.9641V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10.9641 15H18.9641V17H10.9641V15Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgMoveUp(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M17 19.071H15V11.071H17V19.071Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 19.071H7V11.071H9V19.071Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgNametag(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M4 14V20H10V18H6V14H4Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
      ...
      { tag: 'path', attr: { d: 'M4 10V4H10V6H6V10H4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 10V4H14V6H18V10H20Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 14V20H14V18H18V14H20Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgNotifications(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M12 6H4V20H18V12H16V18H6V8H12V6Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgOrganisation(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M17 15H19V17H17V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19 11H17V13H19V11Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgPathCrop(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'rect',
        attr: { opacity: '0.5', x: '6', y: '6', width: '8', height: '8', stroke: 'currentColor', strokeWidth: '2' },
        child: [],
      },
      {
        tag: 'path',
...
function CgPathDivide(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 5H15V9H9V15H5V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9 15V19H19V9H15V15H9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 10H14V14H10V10Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPathTrim(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 5H15V8H8V15H5V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19 9H9V19H19V9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPathUnite(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [{ tag: 'path', attr: { d: 'M15 5H5V15H9V19H19V9H15V5Z', fill: 'currentColor' }, child: [] }],
  })(props)
}
function CgPatreon(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M3 4H7V20H3V4Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPen(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M2 22.9502L4.12171 15.1717L9.77817 20.8289L2 22.9502Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgPlayBackwards(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M2 7H5V17H2V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M6 12L13.0023 7.00003V17L6 12Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21.0023 7.00003L14 12L21.0023 17V7.00003Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPlayButtonO(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M16 12L10 16.3301V7.66987L16 12Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPlayButton(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [{ tag: 'path', attr: { d: 'M15 12.3301L9 16.6603L9 8L15 12.3301Z', fill: 'currentColor' }, child: [] }],
  })(props)
}
function CgPlayForwards(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M21.0023 17H18.0023V7H21.0023V17Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M17.0023 12L10 17V7L17.0023 12Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M2 17L9.00232 12L2 7V17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPlayListAdd(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M2 5H14V7H2V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M2 9H14V11H2V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M10 13H2V15H10V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 9H18V13H22V15H18V19H16V15H12V13H16V9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPlayListCheck(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M15 6H3V8H15V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 10H3V12H15V10Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M3 14H11V16H3V14Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgPlayListRemove(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M15.9644 4.63379H3.96442V6.63379H15.9644V4.63379Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M15.9644 8.63379H3.96442V10.6338H15.9644V8.63379Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M3.96442 12.6338H11.9644V14.6338H3.96442V12.6338Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgPlayListSearch(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M15.8787 4.87866H3.87872V6.87866H15.8787V4.87866Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M15.8787 8.87866H3.87872V10.8787H15.8787V8.87866Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M3.87872 12.8787H11.8787V14.8787H3.87872V12.8787Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgPlayList(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M16 5H4V7H16V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 9H4V11H16V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M4 13H12V15H4V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 16L14 13V19L20 16Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPlayPauseO(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 9H11V15H9V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 15H13V9H15V15Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgPlayPause(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 7H8V17H11V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 17H16V7H13V17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPlayStopO(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M15 9H9V15H15V9Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgPlayStop(props) {
  return GenIcon({
    tag: 'svg',
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [{ tag: 'path', attr: { d: 'M7 7H17V17H7V7Z', fill: 'currentColor' }, child: [] }],
  })(props)
}
...
function CgPlayTrackNextR(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M14 12L8 15.4641V8.5359L14 12Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgPlayTrackNext(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M6 17L14 12L6 7V17Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M18 7H15V12V17H18V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPlayTrackPrev(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M18 17L10 12L18 7V17Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M6 7H9V17H6V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPoll(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M11 7H13V17H11V7Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M15 13H17V17H15V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 10H9V17H7V10Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPullClear(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M6 12H18V14H6V12Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M18 8H6V10H18V8Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPushChevronDownO(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M16 14V16H8V14H16Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgPushChevronDownR(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M8.00001 14H16V16H8.00001V14Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgPushChevronDown(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M19 16.3432H5V18.3432H19V16.3432Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPushChevronLeftO(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M10 16H8V8H10V16Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgPushChevronLeftR(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M9.96265 8.00007V16.0001H7.96265V8.00007H9.96265Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgPushChevronLeft(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M8 19V5H6V19H8Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPushChevronRightO(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M14 8H16V16H14V8Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgPushChevronRightR(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M14.3559 16L14.3559 7.99996H16.3559V16H14.3559Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgPushChevronRight(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M16.3432 19V5H18.3432V19H16.3432Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgPushChevronUp(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M19 8H5V6H19V8Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPushDown(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M18 20.2877H6V22.2877H18V20.2877Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPushLeft(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M3 18V6H1V18H3Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgPushRight(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M20.2877 6V18H22.2877V6H20.2877Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgQuoteO(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M9.06723 9.19629H12.0672L9.93267 14.8038H6.93267L9.06723 9.19629Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
        attr: { d: 'M14.0672 9.19629H17.0672L14.9327 14.8038H11.9327L14.0672 9.19629Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgQuote(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9.13456 9H12.1346L10 14.6075H7L9.13456 9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M14.1346 9H17.1346L15 14.6075H12L14.1346 9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgRatio(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M4 6V12H6V8L10 8V6H4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M20 18H14V16H18V12H20V18Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgSandClock(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M13 6H11V7C11 7.55228 11.4477 8 12 8C12.5523 8 13 7.55228 13 7V6Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgScan(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11 3H13V21H11V3Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgScreenMirror(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 8H19V14H16V16H21V6H3V16H8V14H5V8Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16.3301 19L12 13L7.66987 19H16.3301Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgScreenShot(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M12 8V6H8V10H10V8H12Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M14 14H16V18H12V16H14V14Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgServerless(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M11.7872 6H5V9H10.6953L11.7872 6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9.96735 11H5V14H8.87544L9.96735 11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M11.0038 14L12.0957 11H20V14H11.0038Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8.1475 16H5V19H7.05559L8.1475 16Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M9.18394 19L10.2759 16H20V19H9.18394Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M12.8236 9L13.9156 6H20V9H12.8236Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgShapeSquare(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M17 7H7V17H17V7ZM4 4V20H20V4H4Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgSidebarOpen(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M3 4H21V20H3V4ZM9 6H19V18H9V6Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgSidebarRight(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M3 4H17V20H3V4ZM5 6H15V18H5V6Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M21 4H19V20H21V4Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgSidebar(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M3 20H5V4H3V20Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgSketch(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M8.05592 8H16.0559V10H8.05592V8Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgSmartphoneShake(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 14H11V16H13V14Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
      ...
      { tag: 'path', attr: { d: 'M18 9H20V15H18V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M0 14H2V10H0V14Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M6 15H4V9H6V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M24 10H22V14H24V10Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgSmartphone(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M13 16H11V18H13V16Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgSmileMouthOpen(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 17C14.2091 17 16 15.2091 16 13H8C8 15.2091 9.79086 17 12 17Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgSpaceBetweenV(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M5 5V9H19V5H17V7H7V5H5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 19V15H19V19H17V17H7V19H5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M7 11H17V13H7V11Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgSpaceBetween(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M19 5L15 5L15 19H19V17H17L17 7L19 7V5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M5 5L9 5L9 19H5L5 17H7L7 7H5L5 5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 7V17H11L11 7H13Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgSpectrum(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 16H16C16 11.5817 12.4183 8 8 8V12C10.2091 12 12 13.7909 12 16Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgSpinnerAlt(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M2 12C2 6.47715 6.47715 2 12 2V5C8.13401 5 5 8.13401 5 12H2Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgSpinnerTwoAlt(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 22C17.5228 22 22 17.5228 22 12H19C19 15.866 15.866 19 12 19V22Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgStack(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M20 4V16H22V2H8V4H20Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
      ...
      { tag: 'path', attr: { d: 'M17 7H5V5H19V19H17V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgStopwatch(props) {
  return GenIcon({
    ...
    child: [
      ...
      {
        tag: 'path',
        attr: { d: 'M12.8225 8.60055H10.8225V12.6005H12.8225V8.60055Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgStudio(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M17 13H13V17H17V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M3 3H21V21H3V3ZM5 5H19V19H5V5Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgStyle(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M18 6V12H16V8L12 8V6L18 6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M12 18H6L6 12H8L8 16H12V18Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgSwapVertical(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M12 16H13.5L13.5 10H15.5L15.5 16H17L14.5 19L12 16Z', fill: 'currentColor' },
        child: [],
      },
      { tag: 'path', attr: { d: 'M8 8H9.5L9.5 14H11.5L11.5 8H13L10.5 5L8 8Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgSwap(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M16 13V11.5H10V9.5H16V8L19 10.5L16 13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8 17V15.5H14V13.5H8V12L5 14.5L8 17Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgSweden(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M23 4H10V11H23V4Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M23 13V20H10V13H23Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M8 13V20H1V13H8Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M1 11V4H8V11H1Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgTemplate(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M3 3V9H21V3H3ZM19 5H5V7H19V5Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
      ...
      { tag: 'path', attr: { d: 'M21 11H13V13H21V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 15H21V17H13V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M21 19H13V21H21V19Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgTerminal(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M15 14H11V16H15V14Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgTerrain(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M8 10L3 18H13L8 10Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: { d: 'M10.5286 10.7543L13.5 6L21 18H15.0572L10.5286 10.7543Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgTikcode(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M9 5H5V9H9V5ZM3 3V11H11V3H3Z', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
      ...
      { tag: 'path', attr: { d: 'M13 13H15V21H13V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 13H18V21H16V13Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M19 13H21V21H19V13Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgTime(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M9 7H11V12H16V14H9V7Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgToday(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'rect',
        attr: { opacity: '0.5', x: '7', y: '9', width: '10', height: '10', rx: '1', fill: 'currentColor' },
        child: [],
      },
      {
        tag: 'path',
...
function CgToolbarBottom(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M18 13H6V15H18V13Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgToolbarLeft(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M8 9H6V15H8V9Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgToolbarRight(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M16 9H18V15H16V9Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgToolbarTop(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M18 11H6V9H18V11Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgTrash(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M9 9H11V17H9V9Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M13 9H15V17H13V9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgTrophy(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M18 6H20V11H18V6Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M6 6H4V11H6V6Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgTv(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M8 19.876H16V20.876H8V19.876Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgUnfold(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12H2Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
...
function CgUnsplash(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M15 4.5H9V8.5H15V4.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M4 10.5H9V14.5H15V10.5H20V19.5H4V10.5Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgUsb(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M10 4.5H11V6.5H10V4.5Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M14 4.5H13V6.5H14V4.5Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
          fillRule: 'evenodd',
...
function CgUserAdd(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M18 7H20V9H22V11H20V13H18V11H16V9H18V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgUserList(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M22 11H16V13H22V11Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M16 15H22V17H16V15Z', fill: 'currentColor' }, child: [] },
      { tag: 'path', attr: { d: 'M22 7H16V9H22V7Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
function CgUserRemove(props) {
  return GenIcon({
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M22 9H16V11H22V9Z', fill: 'currentColor' }, child: [] },
    ],
  })(props)
}
...
function CgUserlane(props) {
  return GenIcon({
    ...
    attr: { viewBox: '0 0 24 24', fill: 'none' },
    child: [
      { tag: 'path', attr: { d: 'M15 4H21V10H15V4Z', fill: 'currentColor' }, child: [] },
      {
        tag: 'path',
        attr: {
...
function CgVercel(props) {
  return GenIcon({
    ...
    child: [
      {
        tag: 'path',
        attr: { d: 'M17.9923 17.0225L11.9806 6.97729L6.00775 17.0225H17.9923Z', fill: 'currentColor' },
        child: [],
      },
    ],
  })(props)
