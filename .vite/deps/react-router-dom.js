  ...
  let results = await dataStrategyImpl({
    matches: matches.map((match) => {
      ...
      let resolve = (handlerOverride) => {
        ...
        return shouldLoad
          ? callLoaderOrAction(type, request, match, manifest, mapRouteProperties2, handlerOverride, requestContext)
          : Promise.resolve({
...
var Link = React2.forwardRef(function LinkWithRef(_ref7, ref) {
  let { onClick, relative, reloadDocument, replace, state, target, to, preventScrollReset, unstable_viewTransition } =
      _ref7,
